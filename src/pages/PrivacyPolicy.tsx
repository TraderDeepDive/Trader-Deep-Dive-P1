    ...
    <div>
      ...
      <div className="mx-5 sm:mx-32 mb-20">
        ...
        <p className="mb-5">
          ...
          <a className="text-[#2aa8ff]" href="#payment">
            Payment information
          </a>
        ...
        <p className="mb-5">
          ...
          <a className="text-[#2aa8ff]" href="/cookie-policy" target={"_blank"}>
            Cookies Policy
          </a>
          .<br />
        ...
        <p className="mb-5">
          ...
          <a className="text-[#2aa8ff]" href="#device">
            Device information
          </a>
        ...
        <p className="mb-5">
          ...
          <a className="text-[#2aa8ff]" href="#user-rights">
            User rights
          </a>
          " section below).
        </p>

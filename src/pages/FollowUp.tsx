...
export default function FollowUp() {
  ...
  const url: string = status
    ...
    : "assets/imgs/mobile/mb_products_bg.jpg";
  ...
  return (
    <div className="flex flex-col h-screen">
      <div
        className="bg-[length:100vw_100vh] bg-top bg-no-repeat w-screen h-screen fixed -z-10"
          ...
          <div className="flex flex-col h-full items-center justify-center mx-10">
            ...
            <div className="flex flex-wrap justify-between sm:justify-evenly w-full gap-5 md:-mt-12">
              <div className="w-xs sm:text-center gap-5 sm:gap-0 text-white space-y-[10px] sm:space-y-4 flex sm:block">
                <h1 className="text-[#026ca7] w-12 font-extrabold text-7xl sm:w-auto">
                  1
                </h1>
                <div className="flex justify-between w-full sm:block sm:space-y-4">
                  <div className="space-y-[10px] sm:space-y-4">
                    ...
                    <Link
                      className="text-[#ff6e6a] hidden sm:block"
                    ...
                    <p className="hidden sm:block">
                      If you already have it, click the discord logo!
                    </p>
                  </div>
                  <a
                    className="block hover:scale-110 duration-300"
                    target={"_blank"}
                    href="https://discord.gg/RgjDpBmbFw"
                  >
                    <img
                      src="./assets/svg/discord.svg"
                      className="w-14 mt-2 sm:mt-10 m-auto cursor-pointer"
                    />
                  </a>
                </div>
              </div>
              <div className="max-w-xs sm:text-center gap-5 sm:gap-0 text-white self-end space-y-[10px] sm:space-y-4 flex sm:block">
                ...
                <p>
                  Reach out to either a{" "}
                  <span className="text-[#ff6e6a] font-bold text-lg">
                    Mentor
                  </span>{" "}
                  or a{" "}
                  <span className="text-[#fbb03b] font-bold text-lg">Mod</span>{" "}
                  on the discord server and we will assign you the relevant
                  permissions to access everything you need!
                </p>
              </div>
              <div className="max-w-xs sm:text-center gap-5 sm:gap-0 text-white self-center space-y-[10px] sm:space-y-4 flex sm:block">
                ...
                <p>
                  Ben will schedule a call with you to run through things. Until
                  then, don't be shy, if you see people in any of the channels
                  go and say hi!
                </p>
              </div>
            </div>

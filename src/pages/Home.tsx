...
const Home = () => {
  ...
  return (
    <div className="flex relative flex-col w-full h-screen">
      <div
        className="bg-[length:100vw_100vh] bg-top bg-no-repeat h-screen w-screen fixed top-0 -z-10"
        style={{ backgroundImage: `url(${url})` }}
      ></div>
      {!cookies.email && (
        <Link
          to="/opt-in"
          className="duration-100 absolute top-0 right-0 hover:sm:scale-105 hover:sm:-translate-x-[6px] hover:sm:translate-y-[4px]"
        >
          <svg
            className="fill-[#fbb03b] w-36 h-36 sm:w-40 sm:h-40 md:w-52 md:h-52"
            xmlns="http://www.w3.org/2000/svg"
            id="Layer_2"
            viewBox="0 0 178.8 178.81"
          >
            <g id="Homepage">
              <g>
                <path
                  className="cls-1"
                  d="M110.81,91.77c-.34,.04-.65,.2-.92,.47s-.43,.58-.46,.91c-.04,.34,.05,.61,.26,.82,.21,.21,.49,.3,.83,.26,.34-.04,.65-.19,.91-.45,.27-.27,.43-.58,.46-.92,.04-.34-.05-.62-.26-.83-.21-.21-.49-.3-.83-.25Z"
                />
                <path
                  className="cls-1"
                  d="M101.38,77.04c-.6,.14-1.2,.5-1.79,1.09s-.96,1.19-1.09,1.79c-.13,.6,0,1.09,.39,1.48,.37,.37,.86,.5,1.46,.37,.6-.13,1.2-.49,1.79-1.08s.96-1.2,1.09-1.8c.13-.61,.01-1.1-.36-1.47-.39-.39-.89-.52-1.49-.38Z"
                />
                <path
                  className="cls-1"
                  d="M110.71,83.7c.34-.04,.64-.2,.92-.47s.43-.58,.46-.91-.05-.61-.26-.82-.49-.3-.83-.25c-.34,.04-.64,.2-.9,.46s-.43,.58-.47,.92,.04,.62,.25,.83c.21,.21,.49,.3,.83,.25Z"
                />
                <path
                  className="cls-1"
                  d="M123.36,99.22c-.21-.21-.45-.37-.72-.46-.27-.1-.54-.14-.83-.11-.28,.02-.57,.1-.87,.24-.29,.14-.57,.34-.82,.59-.53,.53-.81,1.09-.85,1.69-.04,.6,.16,1.11,.59,1.55,.21,.21,.45,.37,.71,.46,.26,.09,.54,.13,.82,.11s.57-.1,.87-.24c.29-.14,.57-.34,.82-.59,.53-.53,.81-1.09,.85-1.69,.04-.6-.15-1.11-.58-1.53Z"
                />
                <path
                  className="cls-1"
                  d="M71.38,47.5c-.27-.1-.54-.14-.83-.12-.28,.02-.57,.1-.87,.24-.29,.14-.57,.34-.82,.59-.53,.53-.81,1.09-.85,1.69-.04,.6,.16,1.11,.59,1.55,.21,.21,.45,.37,.71,.46,.26,.09,.54,.13,.82,.11,.28-.02,.57-.1,.87-.24,.29-.14,.57-.34,.82-.59,.53-.53,.81-1.09,.85-1.69,.04-.6-.15-1.11-.58-1.53-.21-.21-.45-.37-.72-.46Z"
                />
                <path
                  className="cls-1"
                  d="M50.81,26.87c-.02-.51-.22-.96-.61-1.35-.4-.4-.85-.6-1.36-.61-.51,0-.99,.17-1.45,.55l2.88,2.88c.38-.47,.56-.95,.55-1.46Z"
                />
                <path
                  className="cls-1"
                  d="M133.25,104.75c-.27-.27-.54-.39-.81-.36-.27,.03-.53,.18-.79,.43l-.28,.28,1.46,1.46s.08-.08,.18-.18c.09-.09,.2-.19,.31-.3s.22-.2,.33-.29c.11-.09,.17-.14,.2-.15-.07-.17-.16-.33-.27-.5-.11-.16-.22-.3-.33-.41Z"
                />
                <path
                  className="cls-1"
                ...
                <path
                  className="cls-1"
                  d="M149.25,125.37c-.27-.1-.54-.14-.83-.12s-.57,.1-.87,.24c-.29,.14-.57,.34-.82,.59-.53,.53-.81,1.09-.85,1.69-.04,.6,.16,1.11,.59,1.55,.21,.21,.45,.37,.71,.46,.26,.09,.54,.13,.82,.11,.28-.02,.57-.1,.87-.24,.29-.14,.57-.34,.82-.59,.53-.53,.81-1.09,.85-1.69,.04-.6-.15-1.11-.58-1.53-.21-.21-.45-.37-.72-.46Z"
                />
              </g>
            </g>
          </svg>
      ...
      <div className="h-full flex flex-col items-center justify-center">
        <Link
          to="/about-us"
          className="flex relative bottom-0 flex-col justify-center items-center text-center h-max"
        >
          <img
            src={"assets/svg/logo.svg"}
            className="m-auto w-[200px] sm:w-[250px] md:w-[280px] xl:w-[300px]"
          />
          <p className="text-[15px] text-[#fff] mt-5 sm:text-[22px]">{text}</p>
        </Link>
      </div>
      {bar}
    </div>
